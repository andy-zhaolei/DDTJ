...
//  
//    public AESUtilsbak(String hexKey) {  
...
//        AESUtilsbak util = new AESUtilsbak("1234567890123456"); // 密钥  
//        System.out.println("cardNo:"+util.encryptData("354667836788")); // 加密  
