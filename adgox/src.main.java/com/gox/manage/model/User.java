...
public class User implements java.io.Serializable{
	...
	public String toString() {
		return "User [id=" + id + ", userId=" + userId + ", userName="
				...
				+ ", mobile=" + mobile + ", createdTime=" + createdTime
				+ ", updatedTime=" + updatedTime + ", wid=" + wid
				+ ", memberUnitsId=" + memberUnitsId + ", hasFundPassword="
				+ hasFundPassword + ", invitationCode=" + invitationCode
				+ ", userType=" + userType + ", flag=" + flag
				+ ", accountMemberunitId=" + accountMemberunitId
				+ ", accountUserId=" + accountUserId + ", unitNo=" + unitNo
				+ ", isRealName=" + isRealName + ", memberChannel="
				+ memberChannel + ", userPic=" + userPic + ", AccessToken="
