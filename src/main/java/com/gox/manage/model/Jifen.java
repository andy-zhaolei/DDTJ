...
public class Jifen implements Serializable{
	...
	public String toString() {
		return "Jifen [id=" + id + ", sum=" + sum + ", login=" + login + ", register=" + register + ", luntang="
				+ luntang + ", juan=" + juan + ", cash=" + cash + ", gendang=" + gendang + ", certName=" + certName
				+ ", shangban=" + shangban + ", questionaire=" + questionaire + ", Atie=" + Atie + ", invitation="
				+ invitation + ", loginParam=" + loginParam + ", loginState=" + loginState + ", registerState="
				+ registerState + ", luntangState=" + luntangState + ", juanState=" + juanState + ", cashState="
				+ cashState + ", gendangState=" + gendangState + ", certNameState=" + certNameState + ", AtieState="
				+ AtieState + ", questState=" + questState + ", invitationState=" + invitationState + ", shangbanState="
				+ shangbanState + ", HD=" + HD + ", HDState=" + HDState + ", createdTime=" + createdTime
